    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 text-center overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-8 mb-12 animate-fade-in" style={{animationDelay: '400ms'}}>
      ...
      <footer className="bg-card/30 backdrop-blur-sm border-t border-border/50 py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-sm">
            © 2024 Meowinc. All scripts are provided for educational and testing purposes.
          </p>
        </div>
      </footer>
    </div>
